...
OBS: Os elemento em Python que inicia e finaliza com duplo underline é chamado de dunder (Double Underline)
...
user = Usuario('Felicity', 'Jones', 'felicity@gmail.com', 'oi')

print(user.contador)
print(user.checa_senha('oi'))
print(user.senha)
print(Usuario.conta_usuarios())
